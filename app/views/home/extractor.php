...
<!-//skycons-icons-->
<link href="/SimpleUser_blue/public/assets/css/demo-page.css" rel="stylesheet" media="all">
<link href="/SimpleUser_blue/public/assets/css/hover.css" rel="stylesheet" media="all">
</head>
<body>	
		...
		<div class="chart-first-line" >
				...
				<div class="col-md-6 chart-blo-1">
					<div class="dygno">
						...
						<label style="width: 150px;"> Salon :	</label><select  style="width : 156px;height:28px;" onchange="testIns()" name = "salon" id = "salon" >
							<?php 								
    ...
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li id="menu-home" ><a href="/SimpleUser_blue/public/Admin/index"><i class="fa fa-cogs"></i><span>Gestion des Aministrateurs</span></a></li>
		        <li id="menu-home" ><a href="/SimpleUser_blue/public/SuperUser/index"><i class="fa fa-tachometer"></i><span>Gestion des utilisateurs</span></a></li>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="background: rgba(32, 152, 209, 0.11)">
               ...
               <label style="width: 200px;margin-top: 7px;"> Type du salon : </label><input type="text" style="width: 200px;" disabled="true" value="<?php echo $data['sector'] ?>" name=""></label><br>
...
<script type="text/javascript">
	...
	$("#ValiderS").click(
				function(){
				$.post('/SimpleUser_blue/public/extractor/index',
				{
					choix:'4',
					NomS:$('[name="NomS"]').val(),
